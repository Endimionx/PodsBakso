...
open class SlideMenuController: UIViewController, UIGestureRecognizerDelegate {
    ...
    //open var buttonBadge = MIBadgeButton()
    ...
    open func initView() {
      ...
      if leftViewController != nil {
        ...
        leftContainerView.backgroundColor = UIColor.white //  UIColor(hex: "0080c1") //UIColor.clear
...
//    open lazy var buttonBadges: MIBadgeButton? = { [unowned self] in
//        
//        let buttonBadge = MIBadgeButton()
//        buttonBadge.setImage(UIImage(named: "ic_slide_shop"), for: UIControlState.normal)
//        buttonBadge.frame = CGRect(x: 0, y: 0, width: 31, height: 31)
//        buttonBadge.badgeString = "08"
//        buttonBadge.badgeBackgroundColor = UIColor.red
//        buttonBadge.badgeEdgeInsets = UIEdgeInsetsMake(10, 0, 0, 7)
//        
//        return buttonBadge
//        }()
    ...
    public func addLeftBarButtonWithImageText(_ buttonImage: UIImage) {
    ...
    public func addRightBarButtonBadge() {
...
//        buttonBadge.badgeBackgroundColor = UIColor.red
//        buttonBadge.badgeEdgeInsets = UIEdgeInsetsMake(10, 0, 0, 7)
//        buttonBadge.addTarget(self, action: #selector(toggleRight), for: UIControlEvents.touchUpInside)
//        
//        self.navigationItem.setRightBarButton(UIBarButtonItem(customView: buttonBadge), animated: false)
//        
        
    }
    
    public func setBadgeString(total: String){
...
//        buttonBadge.setImage(UIImage(named: "ic_slide_shop"), for: UIControlState.normal)
//        buttonBadge.frame = CGRect(x: 0, y: 0, width: 31, height: 31)
//        buttonBadge.badgeString = total
//        buttonBadge.badgeBackgroundColor = UIColor.red
//        buttonBadge.badgeEdgeInsets = UIEdgeInsetsMake(10, 0, 0, 7)
//        buttonBadge.addTarget(self, action: #selector(self.toggleRight), for: UIControlEvents.touchUpInside)
//        
